<?php
class GetMySyncFolder
{
	private $sid;// It has been provided from Creative Cloud Web	
	private static $api = '/folder/getmysyncfolder/';// Service api
	...
	{			
		...
		$dom->encoding = 'UTF-8';
		$root = $dom->createElement('getmysyncfolder');// The root element of request payload 
	...
	function parse($xml) 
	{
		...
		{	
			...
			{
				case 'status':   		 $GetMySyncFolderResponse['status'] = $child; break;
				case 'id':   			 $GetMySyncFolderResponse['id'] = $child; break;
			}	 
		}
