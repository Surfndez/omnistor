...
import net.yostore.aws.asyntask.GetvideoconvertprogressTask;
...
public class MyBrowseActivity extends ListActivity {
	...
	// private void setViedoPlay(final FsInfo fi) {
	//
	// final CharSequence[] items = getResources().getStringArray(
	// R.array.play_way);
	...
	// + "/?dis=" + ApiCookies.sid + "&fi=" + fi.entryId;
	...
	// case 1:// 轉檔撥放
	// / intent = new Intent();
	// intent.setClass(actBrow, PlayVideoInfoActivity.class);
	// GetvideoconvertprogressTask Getvideoconvertprogress = new
	// GetvideoconvertprogressTask(
	// MyBrowseActivity.this, apiCfg, intent, fi.entryId);

	// Getvideoconvertprogress.execute((Void) null);
