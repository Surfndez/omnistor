...
public class LatestChangeFiles extends BaseSaxHandler{

	private GetLatestChangeFilesResponse response = new GetLatestChangeFilesResponse();
	boolean isLatestChangeFiles = false;
		...
		if (this.isLatestChangeFiles){
			if(this.isAttr){
				...
				if (localName.equalsIgnoreCase("entry")){
					response.getLatestChangeFileList().add(lcf);
					this.isLatestChangeFiles = false;
