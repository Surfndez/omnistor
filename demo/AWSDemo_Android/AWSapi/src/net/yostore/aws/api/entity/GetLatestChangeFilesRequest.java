...
public class GetLatestChangeFilesRequest {
	...
	public GetLatestChangeFilesRequest(String userId, String token, int top, String targetroot, int sortdirection){
		this._token = token;
		this.userId = userId;
		this.top = top;
	...
	public String toXml(){
		...
		try {
			...
			serializer.startTag("", "getlatestchangefiles");
			...
			serializer.endTag("", "getlatestchangefiles");
